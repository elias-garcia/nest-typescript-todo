...
describe('MiddlewaresInjector', () => {
    ...
    beforeEach(() => {
        ...
        injector = new middlewares_injector_1.MiddlewaresInjector(container);
    });
    describe('inject', () => {
        const tokens = [1, 2, 3];
        beforeEach(() => {
        ...
        it('should throws "UnkownModuleException" when module is not known', () => {
            ...
            chai_1.expect(() => injector.inject(null, null, '')).to.throws(unkown_module_exception_1.UnkownModuleException);
        });
    ...
    describe('bindMiddleware', () => {
        ...
        it('should throws "RuntimeException" when middleware does not exists in collection', () => {
            ...
            chai_1.expect(() => injector.bindMiddleware('', components)).to.throws(runtime_exception_1.RuntimeException);
        });
